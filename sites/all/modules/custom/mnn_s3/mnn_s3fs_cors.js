/**
 * @file
 * MNN version: Enables client side file uploading to S3.
 */
...
(function ($) {
  ...
  S3fsCORSUpload.handleUpload = function(file_input, button_name) {
    ...
    function submit_to_drupal(data, textStatus, jqXHR) {
      ...
      // MNN modification - submit node form.
      var node_save_btn = document.getElementsByClassName('form-submit');
      if (node_save_btn.length > 0) {
        var btn = $('.form-submit');
        btn.click();
      }
      // End of MNN modification
