      ...
      'civicrm_contribution' => [
        ...
        'filters' => [
          ...
          'contribution_status_id' => [
            ...
            'operatorType' => CRM_Report_Form::OP_MULTISELECT,
<<<<<<< HEAD:sites/all/modules/contrib-stable/civicrm/CRM/Report/Form/Contribute/SoftCredit.php
            'options' => CRM_Contribute_PseudoConstant::contributionStatus(NULL, 'label'),
=======
            'options' => CRM_Contribute_BAO_Contribution::buildOptions('contribution_status_id', 'search'),
>>>>>>> origin/stage:sites/all/modules/contrib/civicrm/CRM/Report/Form/Contribute/SoftCredit.php
            'default' => [1],
          ],
        ],
      ],
