...
<<<<<<< HEAD:sites/all/modules/contrib-stable/civicrm/CRM/Case/XMLProcessor/Process.php
            if (!$this->createRelationships($this->locateNameOrLabel($relationshipTypeXML),
=======
            if (!$this->createRelationships($relationshipTypeXML,
>>>>>>> origin/stage:sites/all/modules/contrib/civicrm/CRM/Case/XMLProcessor/Process.php
              $params
            )
            ) {
