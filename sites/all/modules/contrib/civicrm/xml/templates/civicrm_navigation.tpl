...
( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
<<<<<<< HEAD:sites/all/modules/contrib-stable/civicrm/xml/templates/civicrm_navigation.tpl
...
>>>>>>> origin/stage:sites/all/modules/contrib/civicrm/xml/templates/civicrm_navigation.tpl
