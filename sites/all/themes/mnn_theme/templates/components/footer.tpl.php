...
<footer role="contentinfo" class="footer">
  <div class="region region-footer">
    ...
    <nav role="navigation" aria-labelledby="block-mainnavigation-2-menu" id="block-mainnavigation-2" class="footer-navigation block block-menu navigation menu--main">
      ...
      <ul class="menu">
        <li class="menu-item menu-item--collapsed">
          <a href="https://mnn.org/watch">Watch</a>
        </li>
        <li class="menu-item menu-item--collapsed menu-item--active-trail">
          <a href="https://www.mnn.org/create">Create</a>
        </li>
        <li class="menu-item menu-item--collapsed">
          <a href="https://www.mnn.org/learn">Learn</a>
        </li>
        <li class="menu-item">
          <a href="https://www.mnn.org/news">News</a>
        </li>
        <li class="menu-item menu-item--collapsed">
          <a href="https://www.mnn.org/events">Events</a>
        </li>
        <li class="menu-item menu-item--collapsed">
          <a href="https://www.mnn.org/about">About</a>
        </li>
      </ul>
    </nav>
    ...
    <nav role="navigation" aria-labelledby="block-quicklinks-menu" id="block-quicklinks" class="footer-quick-links block block-menu navigation menu--quick-links">
      ...
      <ul class="menu">
        <li class="menu-item">
          <a href="https://www.mnn.org/watch/tv-schedule">TV Schedule</a>
        </li>
        <li class="menu-item">
          <a href="https://www.mnn.org/learn/orientation">Orientation</a>
        </li>
        <li class="menu-item">
          <a href="https://www.mnn.org/create/producer-resources">Producer Resources</a>
        </li>
      </ul>
    </nav>
    ...
    <div id="block-locations" class="footer-locations">
      <div class="clearfix footer-locations-contentinfo">
        ...
        <h3><a href="https://www.mnn.org/59th-street-studios">59th Street Studios</a></h3>
        ...
        <h3><a href="https://www.mnn.org/mnn-el-barrio-firehouse-community-media-center-0">El Barrio Firehouse</a></h3>
